...
test/emu/taint_test: test/emu/taint_test.o test/emu/codeexec.o src/taint_code.o test/emu/debug.o src/segments.o src/thread_ctx.o src/syscalls_asm.o src/thread_ctx.o src/error.o
	$(LINK) -o $@ $^ $(LDFLAGS) -lreadline

test/emu/cmovtest: test/emu/cmovtest.o src/opcodes.o src/syscalls_asm.o src/thread_ctx.o src/jit_code.o src/debug.o src/error.o src/taint_code.o src/sigwrap_asm.o src/hexdump.o src/segments.o
	$(LINK) -o $@ $^ $(LDFLAGS) -lreadline
