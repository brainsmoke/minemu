...
{
	[TAINT_OR_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_OR_REG_TO_MEM] = TAINT_CHECK_POINTER,
	[TAINT_XOR_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_XOR_REG_TO_MEM] = TAINT_CHECK_POINTER,
	[TAINT_COPY_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_COPY_REG_TO_MEM] = TAINT_CHECK_POINTER,
	[TAINT_BYTE_OR_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_BYTE_OR_REG_TO_MEM] = TAINT_CHECK_POINTER,
	[TAINT_BYTE_XOR_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_BYTE_XOR_REG_TO_MEM] = TAINT_CHECK_POINTER,
	[TAINT_BYTE_COPY_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_BYTE_COPY_REG_TO_MEM] = TAINT_CHECK_POINTER,
	[TAINT_COPY_ZX_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_BYTE_COPY_ZX_MEM_TO_REG] = TAINT_CHECK_POINTER,
	[TAINT_COPY_POP_TO_MEM] = TAINT_CHECK_POINTER,
